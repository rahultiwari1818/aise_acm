    ...
    <section className="py-16 bg-white rounded-xl shadow-md mx-4 md:mx-10 lg:mx-44 my-10">
      ...
      <div className="max-w-5xl mx-auto px-6 text-gray-700 leading-relaxed text-justify">
        ...
        <h2 className="text-2xl font-semibold text-blue-700 mb-4 text-center">
          2030 and Beyond: Will AI Partner with, Replace, or Reinvent Software Engineering?
        </h2>

        {/* Content */}
        <p className="mb-6">
          AISE 2026 will host a dedicated panel discussion exploring the rapidly
          evolving relationship between Artificial Intelligence and Software Engineering.
          The session will bring together experts from software research labs and academia
          to examine how AI is shaping the future of software development, engineering
        ...
        <p className="mb-6">
          ...
          <em>
            Will AI become a collaborative partner to software engineers?
            Could it replace traditional roles? Or will it fundamentally reinvent
            how we engineer software?
          </em>{" "}
          This discussion will highlight current trends, emerging challenges, and
          opportunities for innovation as we move toward 2030 and beyond.
        </p>
        ...
        <div className="bg-indigo-50 border border-indigo-200 p-5 rounded-lg shadow-sm mb-8">
          ...
          <p className="mt-3 text-gray-600">
            Join us as he steers an insightful and thought-provoking dialogue on the
        ...
        <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm">
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <li>
              <strong>Audience:</strong> All registered participants of AISE 2026
            </li>
          </ul>
        </div>

        <p className="mt-6 text-gray-800">
          Mark your calendars! This session is an opportunity to hear from leading
          voices in the field and take part in a conversation that will help shape
